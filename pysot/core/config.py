...
__C.TRAIN.CLS_WEIGHT = 1.5

__C.TRAIN.LOC_WEIGHT = 4.0

__C.TRAIN.SHAPE_WEIGHT =2.0

__C.TRAIN.PD_WEIGHT = 1.0
...
__C.TRAIN.SNAPSHOT_DIR = './snapshotbaseline+su'
...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/home/v4r/Person/CZA/tranhift/train_dataset/vid/crop511'
__C.DATASET.VID.ANNO = 'train_dataset/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '/home/v4r/Person/CZA/tranhift/train_dataset/yt_bb/crop511'
__C.DATASET.YOUTUBEBB.ANNO = 'train_dataset/yt_bb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/home/v4r/Person/CZA/tranhift/train_dataset/coco/crop511'
...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = '/home/v4r/Person/CZA/tranhift/train_dataset/got10k/crop511'         # GOT dataset path
...
__C.DATASET.LaSOT.ROOT = '/home/v4r/Person/CZA/tranhift/train_dataset/lasot/lasot/crop511'         # LaSOT dataset path
