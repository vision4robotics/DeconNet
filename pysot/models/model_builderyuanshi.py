...
from pysot.models.utile.utile import hiftmodule,Adadownsamplingnet
import numpy as np
...
class ModelBuilder(nn.Module):
    def __init__(self):
        ...
        self.downsampling=Adadownsamplingnet().cuda()
    ...
    def forward(self,data):
        ...
        xff=self.downsampling(xf)
        loc,cls1,cls2,resdx,resd=self.grader(xff,zff,xf,zf)  
        ...
        pd_loss=(cfg.TRAIN.w6*Downsamplingloss(zf,zff)+cfg.TRAIN.w7*Downsamplingloss(xf,xff)+cfg.TRAIN.w8*Downsamplingloss(resd,resdx))/3
